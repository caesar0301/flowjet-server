...
This document defines the process, conventions, and guidelines for creating and managing RFCs (Requests for Comments) in the flowjet-server project.
...
RFCs are the authoritative specifications for the flowjet-server system. They define:
...
flowjet-server RFCs fall into three kinds, each with a distinct purpose and level of abstraction:
...
**For questions about RFC management, contact the flowjet-server core team.**
